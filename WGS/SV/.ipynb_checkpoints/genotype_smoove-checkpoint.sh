...
singularity exec ~/smoove_latest.sif smoove genotype -d -x -p 1 --name ${WELL}_joint --outdir ../../../Output/WGS/smoove_output/genotyped/ --fasta ../../../Output/WGS/reference/w303_vlte.fasta --vcf ../../../Output/WGS/smoove_output/merged.sites.vcf.gz ${MYBAMS}
