...
singularity exec ~/smoove_latest.sif smoove call --outdir ../../../Output/WGS/smoove_output/ --name all_samples --fasta ../../../Output/WGS/reference/w303_vlte.fasta -p 1 -x --genotype ../../../Output/WGS/work/*.final.bam
